...
export default function Filter() {
  ...
  const renderFilterItem = (icon, label) => (
    <a href="#" className="flex flex-col items-center justify-center text-center gap-1 transition-all duration-300 ease-in-out hover:scale-110">
  ...
  return (
    <div className="">
      <h2 className='text-gray-500 text-xl flex items-start justify-center font-bold tracking-widest'>
