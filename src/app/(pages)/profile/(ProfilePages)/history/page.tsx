...
export default function History() {
    ...
    const negotiations = [
        { id: 1, name: 'Ana Teca', time: '12:10 AM', status: 'Finalizada' },
        { id: 2, name: 'Ana Teca', time: '12:10 AM', status: 'Em Andamento' },
        { id: 3, name: 'Ana Teca', time: '12:10 AM', status: 'Em Andamento' },
    ];
    ...
    return (
        <div>
                ...
                <div className="mt-10 bg-white rounded-[30px] shadow-[0_0_10px_rgba(0,0,0,0.1)] p-4">
                    ...
                    <div className="space-y-5 rounded-[30px]">
                        {negotiations.map((negotiation) => (
                            <div
                                key={negotiation.id}
                                className="w-full bg-white rounded-[30px] shadow-[0_0_10px_rgba(0,0,0,0.1)] px-5 py-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="mt-10 bg-white rounded-[30px] shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6">
                ...
                <div className="space-y-4">
                    {payments.map((payment) => (
                        <div
                            key={payment.id}
                            className="w-180 bg-white rounded-[30px] shadow-[0_0_10px_rgba(0,0,0,0.1)] px-5 py-4 flex flex-wrap items-center justify-between gap-4">
                            <div className="flex items-center gap-3 min-w-[200px]">
